...
_Generated: 2026-05-18T20:59:45.796Z_
...
Workspace `mcp.json` _(folder: sales-comp-playground)_

- **c:\Users\erquezad\OneDrive - Cisco\Documents\GitHub\sales-comp-playground\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\erquezad\AppData\Roaming\Code\User\mcp.json** — _File missing_
